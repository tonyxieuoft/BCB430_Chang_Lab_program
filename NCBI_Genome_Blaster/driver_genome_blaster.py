...
def enter_taxa(driver: webdriver, taxa: str) -> None:
    """
    Enter assigned_taxa into the NCBI search bar.

    :param driver: driver
    :param taxa: assigned_taxa to enter into the search bar
    :return: None
    """
...
def driver_genome_blaster(save_path: str, queries_path: str,
    ...
    :param taxa_blast_order: the order in which the genomes of assigned_taxa will be
    ...
    for taxa in taxa_blast_order:
        ...
        # search and enter assigned_taxa
        ...
        for i in range(1, len(genome_table_rows)):
            ...
            if taxon_name in species_so_far.keys():
                ...
                if tabs_open == MAX_NUM_TABS:
                    ...
                    parser = BlastXMLParser(file_to_analyze, save_path, taxa,
